...
public class CategoriasAdapter extends RecyclerView.Adapter<CategoriasAdapter.ViewHolder> {
    ...
    public CategoriasAdapter(List<Categorias> listaCategorias, Context context) {
    ...
    public CategoriasAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.items_categorias,parent, false);
